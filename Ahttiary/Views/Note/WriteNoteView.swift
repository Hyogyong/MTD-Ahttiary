...
struct WriteNoteView: View {
    ...
    var body: some View {
        ...
        TabView(selection: $noteManager.pageNumber) {
            ...
            // 첫 번째 감정 체크
            SelectEmotionPageView(noteManager: noteManager, answer: $draftNote.firstHappinessLevel)
                .tag(2)
            ...
            // 두 번째 감정 체크
            SelectEmotionPageView(noteManager: noteManager, answer: $draftNote.secondHappinessLevel)
                .tag(6)
